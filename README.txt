...
In the ErrorSimulator: select 0 for default use, and then view the Error Simulator UI Codes section below for more options.

In the Server: type 'shutdown' when ready to quit.

There are ServerStorage and ClientStorage folders under src/Main/
If the ServerStorage and ClientStorage are not there, please create them as named.
