...
public class ErrorSimulator {
	...
	public void link() {
		...
		try {
			...
			DatagramPacket sendServerPacket = new DatagramPacket(dpClient.getData(), dpClient.getLength(), address,
					port);
			...
			// DatagramPacket dpServer = new DatagramPacket(dataServer,
			// dataServer.length);
			...
			DatagramPacket responsePacket = new DatagramPacket(dpServer.getData(), dpServer.getLength(), clientAddress,
					clientPort);
	...
	public String byteToString(byte[] b, int len) {
		String s = new String(b); // Create new String Object and assign byte[]
									// to it
		try {
